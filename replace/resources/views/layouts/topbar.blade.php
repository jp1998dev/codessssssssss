    ...
    <ul class="ml-auto navbar-nav">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="shadow dropdown-menu dropdown-menu-right animated--grow-in" aria-labelledby="userDropdown">
                ...
                @endphp
                @if($role === 'president' || $role === 'cashier')
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#settingsModal">
                    <i class="mr-2 text-gray-400 fas fa-cogs fa-sm fa-fw"></i>
                    Settings
                </a>
...
<div id="ajax-error" class="alert alert-danger d-none" role="alert"></div>
<div id="ajax-success" class="alert alert-success d-none" role="alert"></div>
