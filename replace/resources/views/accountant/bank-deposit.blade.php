...
<div id="content-wrapper" class="d-flex flex-column">
    <div id="content">
                ...
                <div class="col-md-12">
                    <div class="card shadow mb-4">
                        <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                            <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#newDepositModal">
        ...
        <!-- Modal -->
        <div class="modal fade" id="newDepositModal" tabindex="-1" aria-labelledby="newDepositLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form id="newDepositForm">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="newDepositLabel">New Bank Deposit</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="d-flex align-items-center gap-2 mb-3">
                                ...
                                <span class="fw-bold">System Collection:</span>
                                <span class="text-success fw-semibold">₱{{ number_format($systemTotal, 2) }}</span>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Total Deposited</label>
                                <input type="number" step="0.01" class="form-control" name="total_deposited" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Deposit Slip #</label>
...
@section('scripts')
<script>
    $('#newDepositForm').on('submit', function(e) {
        e.preventDefault();

        const form = $(this);
        const url = `{{ route('accountant.deposits.new') }}`;
