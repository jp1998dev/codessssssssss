                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="step2" role="tabpanel" aria-labelledby="step2-tab">
                                        ...
                                        <div id="irregularCourseSelection" style="display: none;">
                                            ...
                                            <input type="hidden" id="year_level_id" name="year_level_id" value="">
    ...
    `;
        ...
        `);
                    ...
                    function recalculateIrregularTuition() {
                        ...
                        // Get the year level ID from the selected course mapping
                        const selectedMapping = $('#course_mapping_id option:selected');
                        const yearLevelId = selectedMapping.data('year');
                        const yearLevelName = selectedMapping.text().match(/-\s*(.*?)\s*\(/)[1]; // Extracts "4th Year" from the option text
                        ...
                        fetch('{{ route("calculate.irregular.tuition") }}', {
                                ...
                                body: JSON.stringify({
                                    ...
                                    year_level_id: yearLevelId, // Pass the year level ID
                                    year_level_name: yearLevelName // Also pass the name for double-checking
                                })
                            })
