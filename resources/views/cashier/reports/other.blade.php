                                ...
                                <table class="table table-bordered" id="paymentsTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if(!$payment->lrn_number)
                                            <td>{{ $payment->college->first_name }} {{ $payment->college->last_name }}</td>
                                            <td>{{ $payment->yearCourse }}</td>
                                            @else
                                            <td>{{ $payment->shs->first_name ?? 'N/A' }} {{ $payment->shs->last_name ?? '' }}</td>
